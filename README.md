...
| `/scan4duplicates <channel_id>` | **v43** scan a DB2 channel for duplicate posts — first-10-words caption fuzzy match (≥75%, difflib), clustered report with `t.me/c/…` links, chunked output; runs async without blocking the scraper |
